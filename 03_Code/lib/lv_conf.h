...
/*
 * Unveraendertes Template (siehe Kommentar oben), bis auf zwei fuer dieses
 * Projekt noetige Aenderungen: "#if 0" -> "#if 1" (Inhalt aktivieren) und
 * LV_USE_SDL 0 -> 1 weiter unten (PC-Simulator-Fenster via SDL2). Alle
 * anderen Werte sind die von lvgl 9.1.0 selbst vorgeschlagenen Defaults -
 * insbesondere LV_COLOR_DEPTH bleibt bei 16 (RGB565), was zum echten
 * CrowPanel-Display passt (siehe RGB565-Flush-Callback im offiziellen
 * Elecrow-Beispiel RotaryScreen_2_1.ino). Bildassets (assets/generated/)
 * nutzen unabhaengig davon ARGB8888 mit Alphakanal - v9 blendet das beim
 * Zeichnen automatisch passend zum Display-Format.
 */
/* clang-format off */
